...
\ctexset{
    ...
    chapter={
        format+ = \Huge\heiti\raggedright\fontsize{15pt}{0pt},
        name = {,.},
    ...
    section={
        format+ = \Large\heiti\raggedright\fontsize{10.5pt}{0pt},
        name = {,\ },
        number={\num\thesection},
        nameformat={},
        numberformat={},
...
\newCJKfontfamily\fangsong{FZFangSong-Z02S}[AutoFakeBold={3.17}]
